...
// // export function LoginForm({ className, onLogin, ...divProps }: LoginFormProps) {
...
// //       {step === "mobile" && (
// //         <form onSubmit={submitMobile(handleGetOtp)} className="flex flex-col gap-6">
// //           <div className="grid gap-3">
...
// //             />
// //             {mobileErrors.mobile && (
// //               <p className="text-sm text-red-500">{mobileErrors.mobile.message}</p>
// //             )}
// //           </div>
...
// //       {step === "otp" && (
// //         <form onSubmit={submitOtp(handleVerifyOtp)} className="flex flex-col gap-6">
// //           <div className="grid gap-3">
...
// //           <Button type="button" variant="outline" onClick={() => setStep("mobile")}>
// //             Change Number
// //           </Button>
// //         </form>
// //       )}
...
//             avatar: res.data.avatar ?? "https://avatar.vercel.sh/user",
...
//           {step === "mobile" && (
//             <form
//               onSubmit={submitMobile(handleRequestOtp)}
...
export function LoginForm() {
	...
	// ✅ Request OTP
	const handleRequestOtp = (data: MobileForm) => {
						...
						>
							<div className="grid gap-2">
								...
								{requestOtpMutation.isError && (
									<p className="text-sm text-red-500">
										{(requestOtpMutation.error as any)?.response?.data
