...
const billTypeOptions = ["Electricity Bill", "Water Bill", "Gas Bill"];
const statusOptions = ["Unpaid", "Paid"];

export default function CommonAreaBillPage() {
	...
	return (
		<div className="p-8 space-y-6">
			<h1 className="text-2xl font-semibold">Common Area Bill</h1>
			<div className="flex items-center gap-4 mt-6">
				<Input
					placeholder="Search Common Area Bill by bill type"
					className="w-[320px]"
					value={search}
				...
				<Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
					...
					<DialogContent className="sm:max-w-[400px]">
						<DialogHeader>
							<DialogTitle>Add Common Area Bill</DialogTitle>
						</DialogHeader>
