...
const apartmentOptions = ["103", "104", "105", "106"];
...
export default function UtilityBillsPage() {
	...
	return (
		<div className="p-8 space-y-6">
			<h1 className="text-2xl font-semibold">Utility Bills</h1>
			<div className="flex items-center gap-4 mt-6">
				<Input
					placeholder="Search utility bills by Apartment Number, Bill Type"
					className="w-[320px]"
					value={search}
					...
					<DialogContent className="sm:max-w-[400px]">
						...
						<div className="grid gap-4 py-4">
							<div className="grid gap-2">
								...
								<Select
									value={form.apt}
									onValueChange={(v) => setForm((f) => ({ ...f, apt: v }))}
								>
				...
				<table className="w-full text-sm border rounded-lg overflow-hidden">
					<thead className="bg-gray-50">
						<tr>
							...
							<th className="px-2 py-2">APARTMENT NUMBER</th>
					...
					<tbody>
						{bills.map((b, idx) => (
							<tr key={idx} className="border-b">
								...
								<td className="px-2 py-2 font-semibold">{b.apt}</td>
								<td className="px-2 py-2">{b.type}</td>
